  ...
  return (
    <section id="hero" className="relative overflow-hidden">
      <div className="relative bg-gradient-to-b from-[hsl(200_85%_65%)] to-[hsl(200_85%_55%)] min-h-[360px] sm:min-h-[420px] lg:min-h-[540px]">
        ...
        <div className="container mx-auto px-4 py-8 sm:py-10 lg:py-16 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-12">
            ...
            >
              <h1 className="font-display text-4xl sm:text-5xl lg:text-7xl xl:text-8xl text-white text-shadow mb-1 lg:mb-2">WELCOME</h1>
              <h2 className="font-display text-4xl sm:text-5xl lg:text-7xl xl:text-8xl mb-4 lg:mb-8">
            ...
            >
              <motion.img
                ...
                className="w-40 sm:w-56 lg:w-80 xl:w-96 h-auto drop-shadow-2xl rounded-2xl"
                animate={{ y: [0, -10, 0] }}
