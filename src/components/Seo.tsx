...
export default function Seo({ title, description, path, noIndex, jsonLd }: SeoProps) {
  ...
  return (
    <Head>
      ...
      <meta property="og:image:alt" content="Wash King Car Wash tunnel and unlimited wash plans in New Jersey" />
      ...
      <meta name="twitter:image:alt" content="Wash King Car Wash tunnel and unlimited wash plans in New Jersey" />
