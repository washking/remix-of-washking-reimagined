  ...
  return (
    <section id="why-choose" className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Side foliage - left */}
        <div className="absolute left-0 top-1/4 w-32 h-64 bg-[hsl(120_45%_28%)] rounded-r-full opacity-80" />
        <div className="absolute left-0 top-1/3 w-24 h-48 bg-[hsl(120_50%_25%)] rounded-r-full" />
        
        {/* Side foliage - right */}
        <div className="absolute right-0 top-1/4 w-40 h-80 bg-[hsl(120_45%_28%)] rounded-l-full opacity-80" />
        <div className="absolute right-0 top-1/2 w-28 h-56 bg-[hsl(120_50%_25%)] rounded-l-full" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <motion.div
            ...
            className="lg:w-1/2"
          >
            <h2 className="font-display text-4xl lg:text-6xl text-white text-shadow mb-6">
              WHY CHOOSE
            </h2>
            <h2 className="font-display text-5xl lg:text-7xl text-white text-shadow">
              WASHKING?
            </h2>
          </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-16">
          {features.map((feature, index) => (
            ...
            >
              <h3 className="font-display text-washking-brown text-xl lg:text-2xl mb-4">
                {feature.title}
              </h3>
              <p className="text-washking-brown/80 font-body">
                {feature.description}
              </p>
            </motion.div>
          ))}
        ...
        >
          <p className="text-white text-lg lg:text-xl font-body max-w-3xl mx-auto mb-6">
